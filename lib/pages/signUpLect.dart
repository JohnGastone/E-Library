...
class signUpLect extends StatefulWidget {
  const signUpLect({super.key});

  @override
  State<signUpLect> createState() => _signUpLectState();
}

class _signUpLectState extends State<signUpLect> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
